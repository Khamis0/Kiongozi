    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("Master Karibu Ndani ya Kundi Tuna Tarajia Mengi ya Kheri Kutoka kwako!")
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("Kwaheri 🤝 Master")
                return
