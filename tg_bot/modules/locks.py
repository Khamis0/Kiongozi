...
__help__ = """
 - /locktypes: Orodha ya aina zinazowezekana za kufuli..

*Usimamizi tu:*
 - /lock <type>: Aina fulani ya vitu vya kufuli (hazipatikani kibinafsi)..
 - /unlock <type>: Fungua aina fulani ya vitu (haipatikani kibinafsi) ..
 - /locks: Orodha ya kufuli kwenye mazungumzo haya.
