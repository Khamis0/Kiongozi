...
__help__ = """
 - /report <reason>: Jibu kuripoti ujumbe kwa watu wanaohitajika.
 - @admin: Jibu kuripoti ujumbe kwa watu wanaohitajika.
NOTE: Zote mbili hazitafanya kazi ikiwa utatumia majaji

*Admin only:*
 - /reports <on/off>: Badilisha mpangilio wa ripoti, au angalia hali ya sasa.    - Ikiwa PM, toggles hali yako..
   - Ikiwa chatting, inazingatia hali ya mazungumzo hayo.
"""
