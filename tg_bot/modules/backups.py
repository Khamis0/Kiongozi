...
__help__ = """
*Admin only:*
 - /import: Respond to the Group Butler backup file to import as much as possible,
 This makes the transfer very easy! Files / photos cannot be imported due to telegram restrictions.
 - /export:  !!! It's not a command yet, but coming soon!
"""
